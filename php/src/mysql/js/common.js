 ...
 * @Last Modified time: 2018-03-28 16:29:26
 */
...
function ajax(options){
    ...
    if(obj.type==='get' || obj.type ==='jsonp'){
        obj.url += (obj.url.indexOf('?') >= 0 ? '&' : '?') + params;
        params = null;
    }
    ...
    if(obj.type === 'jsonp'){
        ...
        script.src = obj.url + '&' + obj.callbackName + '=' + fnName;
    ...
    xhr.onload = function(){
        if(obj.status.indexOf(xhr.status) >= 0){
